<template>
    <v-container>
        <v-layout row wrap>
            <v-flex xs12 sm10 md-8 offset-sm1 offset-md-2>
                <v-container fluid>
                    <v-layout row>
                        <v-flex xs7 md8>
            ...
            <v-flex v-for="book in filteredBooks" :key="book.id" xs12 sm10 md-8 offset-sm1 offset-md-2>
                <v-card color="info" class="white--text">
                    <v-container fluid>
                        <!-- Layout for desktop version -->
                        <v-layout row class="hidden-sm-and-down">
                            <v-flex xs4 md3>
                                <v-card-media src="https://images-na.ssl-images-amazon.com/images/I/514TVV6S1ML._SY445_.jpg" height="150px"></v-card-media>
                        ...
                        <div class="hidden-md-and-up">
                            <v-layout row >
                                <v-flex xs4 md3>
                                    <v-card-media 
                                    src="https://images-na.ssl-images-amazon.com/images/I/514TVV6S1ML._SY445_.jpg"
                                    height="150px">
                                    </v-card-media>
                                </v-flex>
                                <v-flex xs12>
